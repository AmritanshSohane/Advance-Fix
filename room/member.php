                    ...
                    <div class="ibox float-e-margins">
						...
						?>
								...
								<div class="social-avatar">
									<small class="text-muted">Date & Time <?= $req["join_date"] ?></small>
								</div>
								<div class="social-body">
									<strong><?= $_user["firstName"] . " " . $_user["lastName"]; ?></strong> Client
								<p></p><hr><p></p>
								<div class="file-option">
									...
									<button class="btn btn-danger btn-rounded btn-sm" onclick="delete_member(<?= $req["user_id"] ?>,<?= $req["room_id"] ?>)"><i class="fa fa-times"></i> Delete</button>
								</div>
										</div>
								</div>
							<?php 
